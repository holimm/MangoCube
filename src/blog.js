...
export default function Homepage(){
            ...
            <div className="h-screen w-full bg-cover bg-no-repeat relative" style={{backgroundImage: `url('../img/homepage.jpg')`}}>               
                <div className="h-full w-full absolute bg-gradient-to-b from-transparent via-transparent to-black top-0 z-20">
                    <div className="h-full w-full flex justify-start items-center">
                        <div className="h-fit w-2/4 ml-40">
                            ...
                            <p className="text-2xl cursor-pointer mt-2">Try it out right now!</p>
    ...
    function Blogs (){
        ...
        return(
            <div className="h-fit w-full bg-cover bg-center inline-block relative py-20" style={{backgroundImage: `url('../img/news_bg.jpg')`}}>
